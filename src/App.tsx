...
function App() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      {/* Header */}
      <header className="bg-zinc-900 border-b border-zinc-800 py-3 px-6 flex justify-between items-center">
        <span className="text-amber-400 font-bold tracking-widest text-sm">BANBAN TRAINING CENTER</span>
        <span className="text-zinc-400 text-sm">반반운동센터 / PT</span>
      </header>
